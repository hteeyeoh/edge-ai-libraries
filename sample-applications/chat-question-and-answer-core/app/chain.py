...
from .retriever import retrieve_docs_with_scoring
...
def _prepare_rag_chain_input(chain_input, retriever):
    ...
    docs = retrieve_docs_with_scoring(retriever, effective_question)
    context_text = "\n\n".join(doc.page_content for doc in docs)
    _log_rendered_prompt(context_text, original_question, history)
