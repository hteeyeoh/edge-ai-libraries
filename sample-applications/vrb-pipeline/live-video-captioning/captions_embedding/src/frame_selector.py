...
class FrameSelector:
    def __init__(self, *args, **kwargs):
        try:
            ...
            save_path = args[0] if len(args) > 0 else "/tmp/default_run/"
    ...
    def _save_best_and_cleanup(self, object_id):
        ...
        #filename = f"object_{object_id}_label_{label}.jpg"
    ...
    def save_metadata(self, metadata):
        metadata_output_path = os.path.join(self.output_dir, "frames_metadata.json")
